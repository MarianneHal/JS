...
//     }
// }
function Object(id,name,username,email,address,phone,website,company) {
    this.id=id;
    this.name=name;
    this.username;
    this.email;
    this.address = function (street, suit, city, zipcode,geo) {
        this.street = street;
        this.suite = suite;
        this.city = city;
    ...
    this.suite = addres.suit;
    this.city = address.city;
    thiszipcode = address.zipcode;
    this.geo.lat = address.geo.lat;
    this.geo.lng = address.geo.lng;
    this.phone = phone;
